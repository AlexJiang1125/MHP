  ...
  for (dataset_seed in dataset_seed: dataset_seed) {
    ...
    while (time < 30) {
      ...
      if (time_old < 1 & time > 1) {
        ...
        #save(output, file = paste0("/mnt/beegfs/homes/jiang14/mhp/output/s",files[split_id],"/mhpsemtr_seed_", taskid,"_dataset_" ,dataset_seed,"_time15.RData"))
      }
