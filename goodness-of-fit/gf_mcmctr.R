...
plist <- list()
load("mcmc_1_truncated.RData")
res <- compensator_mcmc(results = results, dim = mydim, out = out, iter_id = b)
fileoutname <- paste0("mcmctr_dim_", mydim, "_", b, ".RData")
save(res, file = file.path("output/mcmctr", fileoutname))
